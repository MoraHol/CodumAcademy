# class responsible for changing the state of the drawing space according to canvas requests
class Commands
  ...
  def fill(x, y, pattern)
    ...
    until stack_positions.empty?
      actual_postion = stack_positions.pop
      next unless matrix[actual_postion[0]][actual_postion[1]] == 0
